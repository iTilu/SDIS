...
class SoundEngineer:
    ...
    def __init__(self, name: str, age: int, experience_years: int, salary: float):
        ...
        self.salary = salary
        self.__sound_equipment: List[str] = []
    ...
    def add_equipment(self, equipment: str) -> None:
        ...
        if equipment not in self.__sound_equipment:
            self.__sound_equipment.append(equipment)
    
    def remove_equipment(self, equipment: str) -> None:
        """Удалить оборудование"""
        if equipment in self.__sound_equipment:
            self.__sound_equipment.remove(equipment)
    
    def get_equipment(self) -> List[str]:
        """Получить список оборудования"""
        return self.__sound_equipment.copy()
